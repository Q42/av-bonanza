...
let xLineWidth = 0.0016;
let xLineOffset = 0.004;
let yLineWidth = 0.003;
let yLineOffset = 0.02;
let bloomAmount = 2;
...
function controlChange(control) {
	// use control.type, .channel, .controllerNumber, .controllerName, .valueconsole.log(control);
